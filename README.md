...
Memory: 4GB RAM.  
Storage: 10 GB Free Space on Hard Disk.  
Database: SQL 2008.  
...
Machine Learning: TensorFlow 2.7.2 / 2.4.0 and Keras 2.2.3 / 2.4.3.  
Computer Vision: OpenCV (opencv-python 4.5.3.56).  
Database: MySQL Server (using Flask-MySQLdb).  
Data Processing & Visualization: Numpy, Pandas, Scikit-learn, and Matplotlib.  
